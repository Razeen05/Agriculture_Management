...
<footer class="footer">
    <section class="box-container">
        <div class="box">
            ...
            <a href="display.php"> <i class="fas fa-angle-right"></i> Market</a>
        ...
        <div class="box">
            <h3>extra links</h3>
            <a href="my_products.php"> <i class="fas fa-angle-right"></i> My products</a>
            <a href="search.php"> <i class="fas fa-angle-right"></i> search</a>
            <a href="update_profile.php"> <i class="fas fa-angle-right"></i>profile</a>
        ...
        <div class="box">
            ...
            <p> <i class="fas fa-envelope"></i> grocerease@gmail.com </p>
